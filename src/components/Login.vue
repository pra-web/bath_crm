          ...
          <div class="text-center col-md-4 col-sm-offset-4">
            ...
            <form class="ui form loginForm"  @submit.prevent="checkCreds">
              ...
              <div class="input-group">
                ...
                <input class="form-control" name="email" placeholder="E-mail" type="text" v-model="email">
              </div>
              ...
              <button type="submit" v-bind:class="'btn btn-primary btn-lg ' + loading">Войти</button>
            </form>
          </div>
        </div>
      </div>
          ...
          if (data.error) {
            if (data.error.name) { //  Object from LDAP at this point
              switch (data.error.name) {
                case 'InvalidCredentialsError' : self.response = 'Имя пользователя или пароль введены неверно'; break
